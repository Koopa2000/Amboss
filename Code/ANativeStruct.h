#ifndef ANATIVESTRUCT_H
#define ANATIVESTRUCT_H
...
// The following is from Process Hacker's native API header files.(THANKS!)
// Ceck it out at: https://github.com/processhacker/phnt
